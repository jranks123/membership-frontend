...
class GuLiveEventTest extends PlaySpecification with Mockito {
  ...
  "GuLiveEventTest" should {
    "contain secure url, metadata and socialUrl for image" in {
      ...
      guEvent.imagerUrl mustEqual "https://some-media-thing/aede0da05506d0d8cb993558b7eb9ad1d2d3e675/294_26_1584_950/{width}.jpg"
      ...
      guEvent.imageUrl mustEqual "https://some-media-thing/aede0da05506d0d8cb993558b7eb9ad1d2d3e675/294_26_1584_950/1000.jpg"
    }
    ...
    "use file url, metadata, socialUrl for image when no secure url is present" in {
      ...
      guEvent.imagerUrl mustEqual "http://some-media-thing/aede0da05506d0d8cb993558b7eb9ad1d2d3e675/0_130_1703_1022/{width}.jpg"
      guEvent.imageMetadata.flatMap(_.description) mustEqual Some("It's Chris!")
      guEvent.imageMetadata.map(_.photographer) mustEqual Some("Joe Bloggs/Guardian Images")

      guEvent.availableWidths mustEqual "1000,500,140"
      guEvent.imageUrl mustEqual "http://some-media-thing/aede0da05506d0d8cb993558b7eb9ad1d2d3e675/0_130_1703_1022/1000.jpg"
    }

    "use fallback image when no image is found from the Grid" in {
      val guEvent = GuLiveEvent(event, None)

      guEvent.imageUrl must contain("event-placeholder.gif")
