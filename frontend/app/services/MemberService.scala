...
import com.gu.zuora.soap.models.Commands.{CreditCardReferenceTransaction, Account, RatePlan, Subscribe}
...
class MemberService(identityService: IdentityService,
  ...
  override def createFreeSubscription(contactId: ContactId, joinData: JoinForm): Future[SubscribeResult] = {
